        ...
        return(
            <nav className='NavbarItems'>
                ...
                <ul className={this.state.bars_clicked ? 'nav-menu active' : 'nav-menu'}>
                    ...
                    <li className='listItem'><a className='nav-link' href='#overview'>Overview</a></li>

                    <li className='listItem'><a href='#student_profile' onClick={this.handleClickProfile} className={this.state.profile_clicked ? 'nav-link-active' : 'nav-link'}>Perfil do Respondente</a></li>
                    ...
                    <li className='listItem'><a href='#about_rae' onClick={this.handleClickRae} className={this.state.rae_clicked ? 'nav-link-active' : 'nav-link'}>Sobre RAE</a></li>
                    ...
                    <li className='listItem'><a href='#about_teacher' onClick={this.handleClickTeacher} className={this.state.teacher_clicked ? 'nav-link-active' : 'nav-link'}>Sobre Professores</a></li>
                    ...
                    <li className='listItem'><a href='#about_institution' onClick={this.handleClickInstitution} className={this.state.institution_clicked ? 'nav-link-active' : 'nav-link'}>Sobre Instituição</a></li>
                    ...
                    <li className='listItem'><a className='nav-link' href='#metodologia'>Metodologia</a></li>
                </ul>
            </nav>
        )
    }
